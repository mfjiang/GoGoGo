...
namespace GoGoGo.DataStorage
{
   ...
   */
    ...
    public class WorkTaskRepo : DataRepoBase<IWorkTask>
    {
        public WorkTaskRepo(string connStr) : base(connStr)
        {
        ...
        {
            return base.GetDataPage(sqlQuery, orderBy, "work_task", pageSize, pageNo, fields);
        }
    }
}
